                            ...
                            <div class="card card-widget widget-user">
                                ...
                                ?>
                                    <div class="widget-user-header">
                                        ...
                                        <h5 class="widget-user-desc text-right">Berita</h5>
                                    </div>
                                    ...
                                    <div class="card-footer">
                                        <div class="row">
                                            <?php
                                            foreach ($berita as $link) :
                                            ?>
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <img src="<?= base_url("assets/images/berita/" . $link['image']); ?>" class="card-img-top" alt="<?= $link['judul'] ?>" style="height:200px">
                                                        <div class="card-body">
                                                            <p class="card-text text-truncate"><?= date("d M Y H:i:s", strtotime($link['tanggal'])) ?> - <i><?= $link['kategori'] == 1 ? "Berita Daerah" : "Berita OPD" ?></i></p>
                                                            <p class="card-text text-truncate fw-bold"><?= $link['judul'] ?></p>
                                                            <br>
                                                            <a href="<?= base_url("berita/detail/" . base64_encode($link['id'])) ?>">
