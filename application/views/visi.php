                            ...
                            <div class="card card-widget widget-user">
                                ...
                                ?>
                                    <div class="widget-user-header">
                                        ...
                                        <h5 class="widget-user-desc text-right">Visi dan Misi</h5>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="description-blocks">
                                                    <h4><span class="title-highlight">Visi</span> Daerah</h4>
                                                    <p style="text-align:justify">
                                                        <strong><?= strtoupper($profile['visi']); ?> </strong>
                                                    </p>
                                                    <h4><span class="title-highlight">Misi</span> Daerah</h4>
                                                    <p style="text-align:justify">
                                                        <?= $profile['misi']; ?>
                                                    </p>
                                                </div>
