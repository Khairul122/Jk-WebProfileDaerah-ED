                        ...
                        <section id="portfolio" class="portfolio">
                            <div class="container" data-aos="fade-up">
                                ...
                                <div class="row" data-aos="fade-up" data-aos-delay="100">
                                    <div class="col-lg-12 d-flex justify-content-center">
                                        <ul id="portfolio-flters">
                                            ...
                                            <li data-filter=".filter-1">Makanan</li>
                                            <li data-filter=".filter-2">SDM</li>
                                            <li data-filter=".filter-3">Fasilitas Dan Pelayanan Publik</li>
                                ...
                                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                                    ...
                                    ?>
                                        <div class="col-lg-4 col-md-6 portfolio-item filter-<?= $galeri['jenis'] ?>">
                                            <img src="<?= base_url("assets/images/gallery/" . $galeri['desc']) ?>" class="img-fluid" alt="">
                                            <div class="portfolio-info">
                                                <a href="<?= base_url("assets/images/gallery/" . $galeri['desc']) ?>" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="<?= $galeri['judul'] ?> <br> <?= $galeri['info'] ?>">
