                ...
                <div class="card-tools">
                    <span data-toggle="tooltip" data-placement="left" title="Tambah Link">
                        <a class="btn btn-tool" data-toggle="modal" data-target="#tambahModal">
                            <i class="fas fa-plus" style="color:blue"></i> Tambah Pengumuman
                        </a>
                    </span>
                </div>
            </div>
...
?>
                            <tr>
                                ...
                                <td class="align-middle"><a href="<?=base_url("assets/images/pengumuman/" . $link['image'])?>" target="_blank"><?=$link['image'];?></a> </td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <small>
                                            <div class="dropdown-menu" role="menu">
                                                ...
                                                <a class="dropdown-item" href="#" onclick="konfirmasi('','<?=$link['id'];?> - <?=$link['judul'];?>','<?=base_url('admin/pengumuman/delete/' . base64_encode($link['id']));?>')">
...
<div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="profile" method="post" action="<?=base_url('admin/pengumuman/save')?>" class="needs-validation" enctype="multipart/form-data">
                <div class="container-fluid">
                    <div class="card card-primary card-outline mt-1">
                        <div class="card-body box-profile">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-sm" id="judul" name="judul" placeholder="Judul Pengumuman">
                            </div>
                            <div class="form-group">
                                <textarea class="form-control form-control-sm" name="keterangan" id="keterangan" rows="10" placeholder="Keterangan"></textarea>
                            </div>
                            <div>
                                <!-- <div id="img-preview"></div> -->
                                <div class="form-group">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="lampiran" name="lampiran" accept="image/*,application/pdf">
                                        <label class="custom-file-label" for="customFile">Pilih lampiran (format gambar/pdf)</label>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php foreach ($links as $link): ?>
    <div class="modal fade" id="editModal<?=$link['id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form id="profile" method="post" action="<?=base_url('admin/pengumuman/update')?>" class="needs-validation" enctype="multipart/form-data">
                    <div class="container-fluid">
                        <div class="card card-primary card-outline mt-1">
                            <div class="card-body box-profile">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="judul" name="judul" placeholder="Judul Pengumuman" value="<?=$link['judul']?>">
                                </div>
                                <div class="form-group">
