                    ...
                    <div class="card-body">
                        <div>
                            <div class="btn-group w-100 mb-2">
                                ...
                                <a class="btn btn-info" href="javascript:void(0)" data-filter="1"> Makanan </a>
                                <a class="btn btn-info" href="javascript:void(0)" data-filter="2"> SDM </a>
                                <a class="btn btn-info" href="javascript:void(0)" data-filter="3">Fasilitas Dan Pelayanan Publik</a>
                            </div>
                            <div class="mb-2">
                        ...
                        <div class="card-body box-profile">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control form-control-sm" name="info" id="info" placeholder="Info"></textarea>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <select name="kategori" id="kategori" class="form-control form-control-sm">
                                            ...
                                            <option value="3">Fasilitas Dan Pelayanan Publik</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
