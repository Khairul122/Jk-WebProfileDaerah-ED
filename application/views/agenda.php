                                                    ...
                                                    <span class="description-text">
                                                        <small>
                                                            <div class="timeline">
                                                                ...
                                                                $rowperpage = 3;
                                                                $j          = 0;
                                                                $waktu      = $this->db->query("select DISTINCT(DATE_FORMAT(tanggal,'%Y-%m-%d')) as tanggal from agenda order by tanggal desc")->result_array();
                                                                ...
                                                                ?>
                                                                    ...
                                                                    $waktud = $this->db->query("select * from agenda where DATE_FORMAT(tanggal,'%Y-%m-%d')='" . $hari['tanggal'] . "' ORDER BY tanggal desc")->result_array();
                                                                        ...
                                                                        <div class="posted" id="posted_<?= $j++ ?>">
                                                                            ...
                                                                            <div class="timeline-item">
                                                                                ...
                                                                                <div class="timeline-footer" style="text-transform: lowercase;">
                                                                                    <a class="link-primary" href="<?= base_url("agenda/detail/" . base64_encode($harid['id'])) ?>"><i>baca selengkapnya</i></a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    <?php endforeach; ?>
